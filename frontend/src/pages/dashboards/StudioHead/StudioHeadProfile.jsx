...
import { getProfile, updateProfile as updateProfileService, uploadProfilePicture, changePassword, uploadSignatureImage } from '../../../services/profileService';

function StudioHeadProfile({ token, user, onLogout }) {
...
export default StudioHeadProfile;
