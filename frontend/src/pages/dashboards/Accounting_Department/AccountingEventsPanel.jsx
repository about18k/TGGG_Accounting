  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#00273C]/60 rounded-xl border border-white/10 p-6 shadow-lg">
        ...
        <div className="space-y-3 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar manage-users-list">
          <style>
          ...
          {events.map((ev) => (
            <div key={ev.id} className="flex items-start gap-4 p-4 rounded-xl bg-[#001f35] border border-white/5 transition-all hover:border-[#FF7120]/20 group">
              ...
              <div className="flex-1 min-w-0">
                ...
                {ev.description && <p className="text-white/40 text-xs mt-2 italic line-clamp-2 leading-relaxed">"{ev.description}"</p>}
              </div>
              {ev.is_holiday && (
