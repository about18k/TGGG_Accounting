...
const AccountingMaterialRequestPage = ({ user }) => {
  ...
  const stats = useMemo(() => {
    ...
    return { total, pendingFunds, fundsReleased, totalExpenses };
  }, [requests]);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-[#001f35]/70 backdrop-blur-md shadow-lg p-6 transition-all duration-300 hover:scale-[1.02] hover:border-[#FF7120]/30 hover:shadow-[0_10px_20px_rgba(0,0,0,0.15)] group">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-white/60 font-medium">Pending Funds</p>
              <p className="text-2xl font-bold mt-2 text-white">{stats.pendingFunds}</p>
            </div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-[#001f35]/70 backdrop-blur-md shadow-lg p-6 transition-all duration-300 hover:scale-[1.02] hover:border-[#FF7120]/30 hover:shadow-[0_10px_20px_rgba(0,0,0,0.15)] group">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-white/60 font-medium">Funds Released</p>
              <p className="text-2xl font-bold mt-2 text-white">{stats.fundsReleased}</p>
            </div>
            <CheckCircle2 className="w-8 h-8 text-[#FF7120] transition-transform duration-300 group-hover:scale-110" />
          </div>
        </div>

        {/* Total Expenses Released Card */}
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-[#001f35]/70 backdrop-blur-md shadow-lg p-6 transition-all duration-300 hover:scale-[1.02] hover:border-[#FF7120]/30 hover:shadow-[0_10px_20px_rgba(0,0,0,0.15)] group">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-white/60 font-medium">Total Released</p>
              <p className="text-2xl font-bold mt-2 text-white">₱{stats.totalExpenses.toLocaleString('en-PH', { maximumFractionDigits: 0 })}</p>
            </div>
      ...
      <div className="rounded-2xl border border-white/10 bg-[#001f35]/70 backdrop-blur-md shadow-lg p-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
        {/* Tab Switcher */}
        ...
        <div className="relative w-full md:max-w-md">
          ...
          <input
            ...
            className="w-full bg-[#00273C]/60 border border-white/10 rounded-xl pl-10 pr-4 py-2.5 text-white placeholder:text-white/30 outline-none focus:border-[#FF7120]/50 transition text-sm"
          />
        </div>
      </div>
      ...
      <BudgetAllocationModal
        ...
        onSuccess={() => {
          fetchRequests(); // Refresh the list to reflect status changes
        }}
      />
    </div>
  );
