...
const JuniorDesignerOvertimePage = ({ user, token, onNavigate }) => {
      ...
      <div className="relative pt-28 px-3 sm:px-6 pb-10">
        <div className="max-w-[1600px] mx-auto flex gap-6">
          <aside className="w-64 shrink-0 hidden lg:block">
            <JuniorDesignerSidebar currentPage="overtime" onNavigate={onNavigate} />
          </aside>
...
export default JuniorDesignerOvertimePage;
