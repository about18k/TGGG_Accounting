    ...
    <div className="space-y-5 sm:space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className={`${cardClass} p-4 sm:p-6 space-y-3`}>
          ...
          <textarea rows={5} value={workDoc} onChange={(e) => setWorkDoc(e.target.value)} placeholder="What site work did you accomplish today?" className="w-full rounded-xl border border-white/15 bg-[#00273C]/60 px-3 py-2 text-sm text-white placeholder:text-white/45 outline-none resize-none" />
