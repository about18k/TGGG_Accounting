...
const SiteCoordinatorTodoPage = ({ user, token, onNavigate, onNotificationUpdate }) => {
  return (
      ...
      <div className="relative pt-40 sm:pt-28 px-3 sm:px-6 pb-10">
        <div className="max-w-[1600px] mx-auto flex gap-6">
          <aside className="w-64 shrink-0 hidden lg:block">
            <SiteCoordinatorSidebar currentPage="todo" onNavigate={onNavigate} />
          </aside>
...
export default SiteCoordinatorTodoPage;
