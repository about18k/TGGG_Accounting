...
function OvertimeForm({ token, activeTab, setActiveTab, renderTabButton, showLeaveTabs }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (!form.employee_signature) {
        toast.error('No Signature', { description: 'No signature found. Please upload a signature in your Profile settings first.' });
        setSaving(false);
        return;
      }
