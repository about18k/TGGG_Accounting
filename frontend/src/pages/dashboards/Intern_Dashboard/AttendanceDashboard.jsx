        ...
        <div className="welcome" style={{ background: '#001f35', padding: '1rem 1rem', borderRadius: '12px', marginBottom: '1rem', boxShadow: '0 1px 3px rgba(0, 0, 0, 0.12)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '0.75rem' }}>
            <div style={{ minWidth: 0, flex: 1 }}>
              <h2 style={{ color: '#ffffff', fontSize: 'clamp(1rem, 4vw, 1.5rem)', fontWeight: '600', marginBottom: '0.25rem', letterSpacing: '-0.02em', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>Welcome, this is an intern dashboard {user?.first_name || 'Villamora'} {user?.last_name || 'Archie'}</h2>
